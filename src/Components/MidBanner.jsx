...
const MidBanner = () => {
  return (
    <div className="bg-gray-100 md:py-24">
      <div
        className="relative max-w-7xl  mx-auto md:rounded-[50px]   pt-28 bg-cover bg-top h-[550px] md:h-[600px]"
        style={{
      ...
      >
        <div className="absolute  inset-0 bg-black/60 md:rounded-[50px] bg-opacity-50 flex items-center justify-center ">
